...
SECRET_KEY = 'h-s9=%j=%i-g9zf-wp=c)o&e#=dd=9wurr5=k&!91!$k7#-#f&'
...
LOGIN_REDIRECT_URL = 'home_view'  # for login redirect nb: name side in the url if you logout in admin this login we create will log admin automatically
LOGIN_URL ='login' # tell django where to find a login profile account and the login is in url pattern before we accesss profile we must login first it a built in django method